        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="가연"
                                checked>가연</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="지영"
                                checked>지영</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="현우"
                                checked>현우</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="종민"
                                checked>종민</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="진혁"
                                checked>진혁</label>
                    </div>
                </div>
